...
{
    public class Direct : Light
    {

        public Direct(Float3 position, Float3 ambient, Float3 diffuse, Float3 specular, float shiness = 10, Buffer texture = null) : base(position, ambient, diffuse, specular, shiness, texture)
        {
        }
